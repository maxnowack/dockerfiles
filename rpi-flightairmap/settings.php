...
//ox model. i.e. top-left | top-right | bottom-right | bottom-left)
...
// TIMEZONE
$globalTimezone = getenv('FLIGHT_TIMEZONE');
...
$globalSquawkCountry = getenv('FLIGHT_SQUAWK_CO');
